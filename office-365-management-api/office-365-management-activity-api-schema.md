...
|[Azure Active Directory-STS-Anmeldeschema](#azure-active-directory-sts-logon-schema)|Das Azure Active Directory-Basisschema wird mit den für alle Azure Active Directory-STS-Anmeldeereignisse spezifischen Eigenschaften erweitert.|
...
## <a name="azure-active-directory-sts-logon-schema"></a>Azure Active Directory-STS-Anmeldeschema
...
|LogonError|Edm.String|Nein|Enthält bei fehlgeschlagenen Anmeldeversuchen den Grund für das Fehlschlagen der Anmeldung.|
...
Die unter [Durchsuchen des Überwachungsprotokolls im Office 365-Schutzcenter](https://support.office.com/en-us/article/Search-the-audit-log-in-the-Office-365-Security-Compliance-Center-0d4d0f35-390b-4518-800e-0c7ec95e946c?ui=en-US&amp;rs=en-US&amp;ad=US) aufgelisteten Yammer-Ereignisse verwenden dieses Schema.
...
|MeetupId|Edm.String|Nein|Ein Bezeichner für eine geplante oder eine Ad-hoc-Besprechung.|
...
## <a name="microsoft-teams-add-ons-schema"></a>Microsoft Teams-Add-Ons-Schema

|**Parameter**|**Typ**|**Erforderlich?**|**Beschreibung**|
|:-----|:-----|:-----|:-----|
|AddOnType|Self.[AddOnType](#addontype)|Nein|Der Typ des Add-Ons, das dieses Ereignis generiert hat.|
|AddonName|Edm.String|Nein|Der Name des Add-Ons, das dieses Ereignis generiert hat.|
|AddOnGuid|Edm.Guid|Nein|Der eindeutige Bezeichner des Add-Ons, das dieses Ereignis generiert hat.|
|TabType|Edm.String|Nein|Der Registerkartentyp, der dieses Ereignis generiert hat.|
...
## <a name="microsoft-teams-settings-schema"></a>Microsoft Teams-Einstellungsschema
...
Office 365 Advanced Threat Protection (ATP) und Threat Intelligence-Ereignisse sind für Office 365-Kunden verfügbar, die ein ATP-, Threat Intelligence- oder E5-Abonnement besitzen. Jedes Ereignis im ATP- und Threat Intelligence-Feed entspricht folgenden Elementen, für die eine Bedrohung erkannt wurde:
...
|DetectionType|Self.[DetectionType](#DetectionType)|Ja|Der Typ der Erkennung.|
...
### <a name="enum-detectiontype---type-edmint32"></a>Enumeration: DetectionType - Typ: Edm.Int32

#### <a name="detectiontype"></a>DetectionType

|**Wert**|**Elementname**|**Beschreibung**|
|:-----|:-----|:-----|
|0|Inline|Die zum Übermittlungszeitpunkt erkannte Bedrohung.|
|1|Delayed|Die nach der Zustellung erkannte Bedrohung.|
|2|ZAP|Nachrichten, die durch [Automatische Bereinigung zur Nullstunde](https://support.office.com/de-DE/article/Zero-hour-auto-purge-protection-against-spam-and-malware-96deb75f-64e8-4c10-b570-84c99c674e15) gelöscht wurden. In der Regel geht Ereignissen mit diesem Erkennungstyp eine Nachricht mit dem Erkennungstyp "Verzögert" voraus.|
