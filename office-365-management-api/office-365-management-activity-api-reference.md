...
- <span data-ttu-id="8da4f-121">Audit.AzureActiveDirectory</span><span class="sxs-lookup"><span data-stu-id="8da4f-121">Audit.AzureActiveDirectory</span></span>
...
- <span data-ttu-id="8da4f-157">**Anzeigenamen für Ressourcen abrufen**, für Objekte im Datenfeed, die durch eine GUID identifiziert werden.</span><span class="sxs-lookup"><span data-stu-id="8da4f-157">**Retrieve resource friendly names** for objects in the data feed identified by guids.</span></span>
...
#### <a name="sample-request"></a><span data-ttu-id="8da4f-283">Beispielanfrage</span><span class="sxs-lookup"><span data-stu-id="8da4f-283">Sample request</span></span>
...
#### <a name="sample-response"></a><span data-ttu-id="8da4f-320">Beispielantwort</span><span class="sxs-lookup"><span data-stu-id="8da4f-320">Sample response</span></span>
...
## <a name="retrieve-resource-friendly-names"></a><span data-ttu-id="8da4f-366">Abrufen von Ressourcen-Anzeigenamen</span><span class="sxs-lookup"><span data-stu-id="8da4f-366">Retrieve resource friendly names</span></span>
...
<span data-ttu-id="8da4f-396">Wir wechseln von einem Grenzwert auf Herausgeberebene zu einem Grenzwert auf Mandantenebene.</span><span class="sxs-lookup"><span data-stu-id="8da4f-396">We're moving from a publisher-level limit to a tenant-level limit.</span></span> <span data-ttu-id="8da4f-397">Dadurch erhält jede Organisation ein eigenes, vollständig zugewiesenes Bandbreitenkontingent erhält für den Zugriff auf ihre Überwachungsdaten.</span><span class="sxs-lookup"><span data-stu-id="8da4f-397">The result is that each organization will get their own fully allocated bandwidth quota to access their auditing data.</span></span> <span data-ttu-id="8da4f-398">Allen Organisationen ist anfänglich eine Baseline von 2.000-Anforderungen pro Minute zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8da4f-398">All organizations are initially allocated a baseline of 2,000 requests per minute.</span></span> <span data-ttu-id="8da4f-399">Dies ist kein statischer, vordefinierter Grenzwert, sondern ein Wert, der auf der Grundlage einer Kombination von Faktoren angepasst wird, beispielweise basierend auf der Anzahl der Arbeitsplätze in der Organisation. Office 365- und Microsoft 365 E5-Organisationen erhalten etwa doppelt so viel Bandbreite wie Nicht-E5-Organisationen.</span><span class="sxs-lookup"><span data-stu-id="8da4f-399">This is not a static, predefined limit but is modeled on a combination of factors including the number of seats in the organization and that Office 365 and Microsoft 365 E5 organizations will get approximately twice as much bandwidth as non-E5 organizations.</span></span> <span data-ttu-id="8da4f-400">Zum Schutz des Diensts gibt es auch eine Obergrenze für die maximale Bandbreite.</span><span class="sxs-lookup"><span data-stu-id="8da4f-400">There will also be cap on the maximum bandwidth to protect the health of the service.</span></span>

<span data-ttu-id="8da4f-401">Weitere Informationen finden Sie im Abschnitt "Zugriff mit hoher Bandbreite auf die Office 365-Verwaltungsaktivitäts-API" in [Erweiterte Überwachung in Microsoft 365](https://docs.microsoft.com/microsoft-365/compliance/advanced-audit#high-bandwidth-access-to-the-office-365-management-activity-api).</span><span class="sxs-lookup"><span data-stu-id="8da4f-401">For more information, see the "High-bandwidth access to the Office 365 Management Activity API" section in [Advanced audit in Microsoft 365](https://docs.microsoft.com/microsoft-365/compliance/advanced-audit#high-bandwidth-access-to-the-office-365-management-activity-api).</span></span>

> [!NOTE] 
> <span data-ttu-id="8da4f-402">Zwar kann jeder Mandant anfänglich bis zu 2.000 Anforderungen pro Minute senden, Microsoft kann aber keine Antwortrate garantieren.</span><span class="sxs-lookup"><span data-stu-id="8da4f-402">Even though each tenant can initially submit up to 2,000 requests per minute, Microsoft cannot guarantee a response rate.</span></span> <span data-ttu-id="8da4f-403">Die Antwortrate hängt von verschiedenen Faktoren ab, z. B. der Leistung des Clientsystems, der Netzwerkkapazität und der Geschwindigkeit des Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="8da4f-403">The response rate depends on various factors, such as client system performance, network capacity, and network speed.</span></span> 

## <a name="errors"></a><span data-ttu-id="8da4f-404">Fehler</span><span class="sxs-lookup"><span data-stu-id="8da4f-404">Errors</span></span>

<span data-ttu-id="8da4f-405">Wenn der Dienst einen Fehler feststellt, meldet er den Fehlerantwortcode an den Aufrufer, und zwar mithilfe der standardmäßigen HTTP-Fehlercodesyntax.</span><span class="sxs-lookup"><span data-stu-id="8da4f-405">When the service encounters an error, it will report the error response code to the caller, using standard HTTP error-code syntax.</span></span> <span data-ttu-id="8da4f-406">.</span><span class="sxs-lookup"><span data-stu-id="8da4f-406">.</span></span> <span data-ttu-id="8da4f-407">Zusätzliche Informationen sind im Text des fehlgeschlagenen Aufrufs als einzelnes JSON-Objekt enthalten.</span><span class="sxs-lookup"><span data-stu-id="8da4f-407">Additional information is included in the body of the failed call as a single JSON object.</span></span> <span data-ttu-id="8da4f-408">Nachfolgend finden Sie ein Beispiel für einen vollständige JSON-Fehlertext:</span><span class="sxs-lookup"><span data-stu-id="8da4f-408">An example of a full JSON error body is shown below:</span></span> 
...
|||
|:-----|:-----|
|<span data-ttu-id="8da4f-409">Code</span><span class="sxs-lookup"><span data-stu-id="8da4f-409">Code</span></span>|<span data-ttu-id="8da4f-410">Nachricht</span><span class="sxs-lookup"><span data-stu-id="8da4f-410">Message</span></span>|
|<span data-ttu-id="8da4f-411">AF10001</span><span class="sxs-lookup"><span data-stu-id="8da4f-411">AF10001</span></span>|<span data-ttu-id="8da4f-412">Der Berechtigungssatz ({0}), der in der Anforderung gesendet wurde, enthielt nicht die erwartete Berechtigung **ActivityFeed.Read**.</span><span class="sxs-lookup"><span data-stu-id="8da4f-412">The permission set ({0}) sent in the request did not include the expected permission **ActivityFeed.Read**.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-413">{0} = die im Zugriffstoken festgelegte Berechtigung.</span><span class="sxs-lookup"><span data-stu-id="8da4f-413">{0} = the permission set in the access token.</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-414">AF20001</span><span class="sxs-lookup"><span data-stu-id="8da4f-414">AF20001</span></span>|<span data-ttu-id="8da4f-415">Fehlender Parameter: {0}</span><span class="sxs-lookup"><span data-stu-id="8da4f-415">Missing parameter: {0}.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-416">{0} = der Name des fehlenden Parameters.</span><span class="sxs-lookup"><span data-stu-id="8da4f-416">{0} = the name of the missing parameter.</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-417">AF20002</span><span class="sxs-lookup"><span data-stu-id="8da4f-417">AF20002</span></span>|<span data-ttu-id="8da4f-418">Ungültiger Parametertyp: {0}</span><span class="sxs-lookup"><span data-stu-id="8da4f-418">Invalid parameter type: {0}.</span></span> <span data-ttu-id="8da4f-419">Erwarteter Typ: {1}</span><span class="sxs-lookup"><span data-stu-id="8da4f-419">Expected type: {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-420">{0} = der Name des ungültigen Parameters.</span><span class="sxs-lookup"><span data-stu-id="8da4f-420">{0} = the name of the invalid parameter.</span></span></p></li><li><p><span data-ttu-id="8da4f-421">{1} = der erwartete Typ (int, datetime, guid).</span><span class="sxs-lookup"><span data-stu-id="8da4f-421">{1} = the expected type (int, datetime, guid).</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-422">AF20003</span><span class="sxs-lookup"><span data-stu-id="8da4f-422">AF20003</span></span>|<span data-ttu-id="8da4f-423">Angegebener Ablauf {0} ist auf ein Datum und eine Uhrzeit in der Vergangenheit festgelegt.</span><span class="sxs-lookup"><span data-stu-id="8da4f-423">Expiration {0} provided is set to past date and time.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-424">{0} = der im API-Aufruf übergebene Ablauf.</span><span class="sxs-lookup"><span data-stu-id="8da4f-424">{0} = the expiration passed in the API call.</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-425">AF20010</span><span class="sxs-lookup"><span data-stu-id="8da4f-425">AF20010</span></span>|<span data-ttu-id="8da4f-426">Die in der URL ({0}) übergebene Mandanten-ID stimmt nicht mit der im Zugriffstoken ({1}) übergebenen Mandanten-ID überein.</span><span class="sxs-lookup"><span data-stu-id="8da4f-426">The tenant ID passed in the URL ({0}) does not match the tenant ID passed in the access token ({1}).</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-427">{0} = in der URL übergebene Mandanten-ID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-427">{0} = tenant ID passed in the URL</span></span></p></li><li><p><span data-ttu-id="8da4f-428">{1} = im Zugriffstoken übergebene Mandanten-ID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-428">{1} = tenant ID passed in the access token</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-429">AF20011</span><span class="sxs-lookup"><span data-stu-id="8da4f-429">AF20011</span></span>|<span data-ttu-id="8da4f-430">Angegebene Mandanten-ID ({0}) ist im System nicht vorhanden oder wurde gelöscht.</span><span class="sxs-lookup"><span data-stu-id="8da4f-430">Specified tenant ID ({0}) does not exist in the system or has been deleted.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>   <span data-ttu-id="8da4f-431">{0} = in der URL übergebene Mandanten-ID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-431">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-432">AF20012</span><span class="sxs-lookup"><span data-stu-id="8da4f-432">AF20012</span></span>|<span data-ttu-id="8da4f-433">Angegebene Mandanten-ID ({0}) ist im System falsch konfiguriert.</span><span class="sxs-lookup"><span data-stu-id="8da4f-433">Specified tenant ID ({0}) is incorrectly configured in the system.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>    <span data-ttu-id="8da4f-434">{0} = in der URL übergebene Mandanten-ID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-434">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-435">AF20013</span><span class="sxs-lookup"><span data-stu-id="8da4f-435">AF20013</span></span>|<span data-ttu-id="8da4f-436">Die in der URL ({0}) übergebene Mandanten-ID ist keine gültige GUID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-436">The tenant ID passed in the URL ({0}) is not a valid GUID.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p> <span data-ttu-id="8da4f-437">{0} = in der URL übergebene Mandanten-ID.</span><span class="sxs-lookup"><span data-stu-id="8da4f-437">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-438">AF20020</span><span class="sxs-lookup"><span data-stu-id="8da4f-438">AF20020</span></span>|<span data-ttu-id="8da4f-439">Der angegebene Inhaltstyp ist ungültig.</span><span class="sxs-lookup"><span data-stu-id="8da4f-439">The specified content type is not valid.</span></span>|
|<span data-ttu-id="8da4f-440">AF20021</span><span class="sxs-lookup"><span data-stu-id="8da4f-440">AF20021</span></span>|<span data-ttu-id="8da4f-441">Der Webhook-Endpunkt {{0}) konnte nicht überprüft werden.</span><span class="sxs-lookup"><span data-stu-id="8da4f-441">The webhook endpoint {{0}) could not be validated.</span></span> <span data-ttu-id="8da4f-442">{1}</span><span class="sxs-lookup"><span data-stu-id="8da4f-442">{1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-443">{0} = Webhookadresse.</span><span class="sxs-lookup"><span data-stu-id="8da4f-443">{0} = webhook address.</span></span></p></li><li><p><span data-ttu-id="8da4f-444">{1} = „Der Endpunkt hat nicht HTTP 200 zurückgegeben.“</span><span class="sxs-lookup"><span data-stu-id="8da4f-444">{1} = "The endpoint did not return HTTP 200."</span></span> <span data-ttu-id="8da4f-445">oder „Die Adresse muss mit HTTPS beginnen.“</span><span class="sxs-lookup"><span data-stu-id="8da4f-445">or "The address must begin with HTTPS."</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-446">AF20022</span><span class="sxs-lookup"><span data-stu-id="8da4f-446">AF20022</span></span>|<span data-ttu-id="8da4f-447">Kein Abonnement für den angegebenen Inhaltstyp gefunden.</span><span class="sxs-lookup"><span data-stu-id="8da4f-447">No subscription found for the specified content type.</span></span>|
|<span data-ttu-id="8da4f-448">AF20023</span><span class="sxs-lookup"><span data-stu-id="8da4f-448">AF20023</span></span>|<span data-ttu-id="8da4f-449">Das Abonnement wurde von {0} deaktiviert.</span><span class="sxs-lookup"><span data-stu-id="8da4f-449">The subscription was disabled by {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-450">{0} = „ein Mandant“ oder „ein Dienstadministrator“.</span><span class="sxs-lookup"><span data-stu-id="8da4f-450">{0} = "a tenant admin" or "a service admin"</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-451">AF20030</span><span class="sxs-lookup"><span data-stu-id="8da4f-451">AF20030</span></span>|<span data-ttu-id="8da4f-452">Es muss sowohl die Startzeit als auch die Endzeit angegeben werden (oder beide nicht angegeben werden), und die Zeitangaben dürfen nicht mehr als 24 Stunden auseinander liegen, wobei die Startzeit nicht mehr als sieben Tagen in der Vergangenheit liegen darf.</span><span class="sxs-lookup"><span data-stu-id="8da4f-452">Start time and end time must both be specified (or both omitted) and must be less than or equal to 24 hours apart, with the start time no more than 7 days in the past.</span></span>|
|<span data-ttu-id="8da4f-453">AF20031</span><span class="sxs-lookup"><span data-stu-id="8da4f-453">AF20031</span></span>|<span data-ttu-id="8da4f-454">Ungültige nextPage-Eingabe: {0}.</span><span class="sxs-lookup"><span data-stu-id="8da4f-454">Invalid nextPage Input: {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-455">{0} = der in der URL übergebene Indikator für die nächste Seite</span><span class="sxs-lookup"><span data-stu-id="8da4f-455">{0} = the next page indicator passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-456">AF20050</span><span class="sxs-lookup"><span data-stu-id="8da4f-456">AF20050</span></span>|<span data-ttu-id="8da4f-457">Der angegebene Inhalt ({0}) ist nicht vorhanden.</span><span class="sxs-lookup"><span data-stu-id="8da4f-457">The specified content ({0}) does not exist.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-458">{0} = Ressourcen-ID oder Ressourcen-URL</span><span class="sxs-lookup"><span data-stu-id="8da4f-458">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-459">AF20051</span><span class="sxs-lookup"><span data-stu-id="8da4f-459">AF20051</span></span>|<span data-ttu-id="8da4f-460">Mit dem Schlüssel {0} angeforderter Inhalt ist bereits abgelaufen.</span><span class="sxs-lookup"><span data-stu-id="8da4f-460">Content requested with the key {0} has already expired.</span></span> <span data-ttu-id="8da4f-461">Inhalt, der älter als 7 Tage ist, kann nicht abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="8da4f-461">Content older than 7 days cannot be retrieved.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-462">•    {0} = Ressourcen-ID oder Ressourcen-URL</span><span class="sxs-lookup"><span data-stu-id="8da4f-462">•    {0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-463">AF20052</span><span class="sxs-lookup"><span data-stu-id="8da4f-463">AF20052</span></span>|<span data-ttu-id="8da4f-464">Inhalts-ID {0} in der URL ist ungültig.</span><span class="sxs-lookup"><span data-stu-id="8da4f-464">Content ID {0} in the URL is invalid.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-465">{0} = Ressourcen-ID oder Ressourcen-URL</span><span class="sxs-lookup"><span data-stu-id="8da4f-465">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-466">AF20053</span><span class="sxs-lookup"><span data-stu-id="8da4f-466">AF20053</span></span>|<span data-ttu-id="8da4f-467">Im Header „Accept-Language“ darf nur eine Sprache vorhanden sein.</span><span class="sxs-lookup"><span data-stu-id="8da4f-467">Only one language may be present in the Accept-Language header.</span></span>|
|<span data-ttu-id="8da4f-468">AF20054</span><span class="sxs-lookup"><span data-stu-id="8da4f-468">AF20054</span></span>|<span data-ttu-id="8da4f-469">Ungültige Syntax im Accept-Language-Header.</span><span class="sxs-lookup"><span data-stu-id="8da4f-469">Invalid syntax in Accept-Language header.</span></span>|
|<span data-ttu-id="8da4f-470">AF429</span><span class="sxs-lookup"><span data-stu-id="8da4f-470">AF429</span></span>|<span data-ttu-id="8da4f-471">Zu viele Anforderungen.</span><span class="sxs-lookup"><span data-stu-id="8da4f-471">Too many requests.</span></span> <span data-ttu-id="8da4f-472">Method={0}, PublisherId={1}</span><span class="sxs-lookup"><span data-stu-id="8da4f-472">Method={0}, PublisherId={1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="8da4f-473">{0} = HTTP-Methode</span><span class="sxs-lookup"><span data-stu-id="8da4f-473">{0} = HTTP Method</span></span></p></li><li><p><span data-ttu-id="8da4f-474">{1} = Mandanten-GUID, die als PublisherIdentifier verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="8da4f-474">{1} = Tenant GUID used as PublisherIdentifier</span></span></p></li></ul>|
|<span data-ttu-id="8da4f-475">AF50000</span><span class="sxs-lookup"><span data-stu-id="8da4f-475">AF50000</span></span>|<span data-ttu-id="8da4f-476">Ein interner Fehler ist aufgetreten.</span><span class="sxs-lookup"><span data-stu-id="8da4f-476">An internal error occurred.</span></span> <span data-ttu-id="8da4f-477">Wiederholen Sie die Anforderung.</span><span class="sxs-lookup"><span data-stu-id="8da4f-477">Retry the request.</span></span>|
